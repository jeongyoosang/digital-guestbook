...
const STEPS: StepData[] = [
  ...
  { id: "report", sectionId: "sf-report", title: "04. 웨딩 리포트", desc: "예식 종료와 동시에 명단, 메시지, 정산 내역이 깔끔한 리포트로 생성됩니다.", dDay: "D-Day (종료)", icon: "📊", label: "웨딩 리포트", images: ["/serviceflow2.jpg"], theme: "post" },
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:py-20">
        <div className="grid gap-16 lg:grid-cols-[1fr_420px]">
              ...
              <section key={step.id} id={step.sectionId} className="scroll-mt-48">
                <div className="mb-8 space-y-3">
                  ...
                  <div className="text-lg leading-relaxed text-slate-500">
                    <p>{step.desc}</p>
                    {step.id === "guest" && (
                      <p className="mt-2 text-sm font-semibold text-slate-400 opacity-80">
          ...
          <div className="hidden lg:block">
            {/* pt-0으로 수정하여 상단 여백 완전히 제거 */}
            <div className="sticky top-24 flex flex-col items-center pt-0 pb-8 px-8 rounded-[3rem] bg-slate-50/50 border border-slate-100 backdrop-blur-sm">
              ...
              <div className="relative flex flex-col items-center w-full pt-8">
                ...
                <div className="absolute right-0 top-[35%] translate-x-4">
